...
{
    @private
    __unsafe_unretained id<DrawPatternLockViewControllerDelegate> delegate;
    DrawPatternLockView * _v;
}
@property(nonatomic, assign) id<DrawPatternLockViewControllerDelegate> delegate;
@property(nonatomic, assign) DrawPatternCtlType drawPatternCtlType;
/**
 其它属性
 */
@property(nonatomic, retain, readonly) NSString * lastGesturePwdStr;//最后一次手势密码
/**
 辅助信息
 */
...
/**
 辅助信息
 */
@property(nonatomic, retain) NSString * currentAccountStr;//当前登录帐号
